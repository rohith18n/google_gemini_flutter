import 'package:acetime/configs/common/trained_data.dart';
import 'package:acetime/configs/enums/chat_role.dart';
import 'package:acetime/model/chat.dart';
import 'package:acetime/repositry/repositry/bard_chat_repositry.dart';
import 'package:acetime/repositry/services/bard_chat_service.dart';
...
class MessageProvider extends ChangeNotifier {
  ...
  final List<Message> _messages = [
    Message(
      role: ChatRole.model,
      message: 'Heyy! How can I assist you today? 🤝 ',
    ),
  ];
